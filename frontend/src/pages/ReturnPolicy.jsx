  ...
  return (
    <div style={textualStyle}>
      ...
      <p style={{ marginBottom: '20px' }}>
        At easyMart, we proudly stand behind the quality of our merchandise. If for any reason you are completely disastified with your purchase, you may securely initiate a return within 30 days of receiving your order.
      </p>

      <h4 style={{ color: '#b3aeaa', marginTop: '25px', marginBottom: '10px' }}>1. Eligibility for Returns</h4>
      ...
      <h4 style={{ color: '#b3aeaa', marginTop: '25px', marginBottom: '10px' }}>2. Refund Processing</h4>
      <p style={{ marginBottom: '15px' }}>
      ...
      <h4 style={{ color: '#b3aeaa', marginTop: '25px', marginBottom: '10px' }}>3. Exempted Output Goods</h4>
      <p style={{ marginBottom: '15px' }}>
      ...
      <h4 style={{ color: '#b3aeaa', marginTop: '25px', marginBottom: '10px' }}>4. Shipping Transit Costs</h4>
      <p>
