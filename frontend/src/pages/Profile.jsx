...
const Profile = () => {
  ...
  const badgeStyle = {
    background: 'rgba(172, 166, 161, 0.1)',
    color: '#e6dcb5',
    padding: '6px 12px',
    borderRadius: '8px',
    fontSize: '0.9rem',
  ...
  return (
    <div style={containerStyle}>
      ...
      >
        <div>
          <h2 style={{ color: '#fff', fontSize: '2.2rem', marginBottom: '10px' }}>
            My Profile
          </h2>

          <p style={{ color: '#a1a1aa', fontSize: '1.2rem', marginBottom: '5px' }}>
            <strong>Name:</strong> {user.name}
          </p>

          <p style={{ color: '#a1a1aa', fontSize: '1.2rem', marginBottom: '15px' }}>
      ...
      <h3 style={{ color: '#fdfdfd', marginBottom: '20px', fontSize: '1.5rem' }}>
        Order History
      </h3>
