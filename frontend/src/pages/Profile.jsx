...
const Profile = () => {
  ...
  const badgeStyle = { background: 'rgba(172, 166, 161, 0.1)', color: '#e6dcb5', padding: '6px 12px', borderRadius: '8px', fontSize: '0.9rem', fontWeight: 'bold', display: 'inline-block' };
  ...
  return (
    <div style={containerStyle}>
      ...
      <h3 style={{ color: '#fdfdfd', marginBottom: '20px', fontSize: '1.5rem' }}>Order History</h3>
      {loading ? (
